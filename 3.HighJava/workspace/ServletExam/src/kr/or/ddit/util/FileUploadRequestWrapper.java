...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
    ...
    private Map<String, String[]> parameterMap;											// 폼필드(파라미터) 데이터를 담기 위한 맵, 여러개를 담기 위해 배열을 넣음
    private Map<String, FileItem[]> fileItemMap;										// fileItem객체를 담기위한 맵, 여러개를 담기 위해 배열을 넣음
