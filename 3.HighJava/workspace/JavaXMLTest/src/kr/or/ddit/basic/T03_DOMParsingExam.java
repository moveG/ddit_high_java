 		...
 		if(code.equals("INFO-000")) {
 			for(int i = 0; i < rowNodeList.getLength(); i++) {
 				...
 				String rowNum = element.getElementsByTagName("ROW_NUM")
 						.item(0).getTextContent();
 				String irdnNm = element.getElementsByTagName("IRDNT_NM")
 						.item(0).getTextContent();
 				String irdnCpcty = element.getElementsByTagName("IRDNT_CPCTY")
 						.item(0).getTextContent();
 				String irdnTyNm = element.getElementsByTagName("IRDNT_TY_NM")
 						.item(0).getTextContent();
 				String str = String.format("%3s %8s %10s %10s %8s", 
 						rowNum, recipeId, irdnTyNm, irdnNm, irdnCpcty);
