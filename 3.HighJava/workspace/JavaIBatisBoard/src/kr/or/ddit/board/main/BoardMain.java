...
public class BoardMain {
	...
	private void write() {
		...
		BoardVO bv = new BoardVO();
		bv.setBoardTitle(boardTitle.trim());
		bv.setBoardContent(boardContent.trim());
		bv.setBoardWriter(boardWriter.trim());
	...
	private void read() {
		...
		BoardVO bvo = boardService.readBoard(no);
		
		System.out.println();
		System.out.println("=========================================================");
		System.out.println(bvo.getBoardNo() + "번 게시물");
		System.out.println("제목 : " + bvo.getBoardTitle());
		System.out.println("=========================================================");
		System.out.println("내용 : ");
		System.out.println(bvo.getBoardContent());
		System.out.println();
		System.out.println("=========================================================");
		System.out.println("작성자 : " + bvo.getBoardWriter());
		System.out.println("작성일 : " + bvo.getBoardDate());
		System.out.println("=========================================================");
