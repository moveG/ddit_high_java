...
public class T01_EnumTest {
	...
	//생성자를 쓰지 않았지만 컴파일러가 자동으로 생성자를 선언해줌
	public enum City {서울, 부산, 대구, 광주, 대전};
	
	public enum MyCity {서울, 부산, 대구, 광주, 대전};
	...
	public static void main(String[] args) {
		...
		//toString()이 자동으로 호출되기 때문에 myCity1.name()대신 myCity1만 넣어도 잘 출력됨
		System.out.println("myCity1의 oridnal : " + myCity1.ordinal());
		System.out.println("");

		System.out.println("myCity2 : " + myCity2.name());
		System.out.println("myCity2의 oridnal : " + myCity2.ordinal());
		System.out.println("=============================");
		
		Season ss = Season.valueOf("여름");
		System.out.println("name : " + ss.name());
		System.out.println("ordinal(순서) : " + ss.ordinal());
		...
		//City타입의 대구와 City타입의 대전과 비교함, 서로 다르므로 false를 반환함
		
//		System.out.println(city == MyCity.대구);
		//City.대구 대신 MyCity.대구를 넣으면 컴파일 오류가 발생함
		//대구라는 이름은 동일하지만 타입이 City와 MyCity로 서로 다르므로 서로 비교할 수 없음
		//enum을 사용하면 타입까지 체크할 수 있어 타입안전한 코드를 작성할 수 있게 됨
