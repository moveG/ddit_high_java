...
public class IbatisTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//1-2. 위에서 읽어온 Reader객체를 이용하여 실제 작업을 진행할 객체를 생성하기
			SqlMapClient smc = SqlMapClientBuilder.buildSqlMapClient(rd);	//static메서드
...
//			System.out.println("================================");
			...
			//2) 응답의 결과가 한개인 경우...
			//응답결과가 하나라도 리스트에 넣어서 다룰 수 있다.
			//리스트 입출력의 귀찮음을 덜기 위해  따로 queryForObject를 사용해준다.
			System.out.println("select작업 시작(응답의 결과가 한개인 경우)...");
