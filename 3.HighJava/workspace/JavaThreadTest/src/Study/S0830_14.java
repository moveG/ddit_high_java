...
public class S0830_14 {
	...
	public static void main(String[] args) {
		...
		//처리할 스레드 객체 생성
		CalculatePI cp = new CalculatePI(sd);
...
class CalculatePI extends Thread {
	...
	public CalculatePI(ShareData sd) {
		this.sd = sd;
	}
...
class PrintPI extends Thread {
	...
	public void run() {
		...
		System.out.println("비교용 원주율 : " + Math.PI);
		System.out.println("===============================");
	}
}
